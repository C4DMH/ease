...
write.csv(afinn_subj, file = "A:/Studies/EASE/output/scored_text_data/afinn_scores.csv")
write.csv(bing_subj, file = "A:/Studies/EASE/output/scored_text_data/bing_scores.csv")
```
