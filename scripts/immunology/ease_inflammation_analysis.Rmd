...
library(Hmisc)
library(tidyverse)
all_4corr <- select(immunology_plus_dataset, "il1b_w_avg","crp_w_avg","afinn_avg","bing_pos_ratio","bing_tot_neg", "bing_tot_pos","bing_tot_aff","tot_words_avg","dass_anx_avg","dass_dep_avg","dass_str_avg","pss_avg","ssic_avg","tot_hr_sleep","strain_ct_stress_tot","strain_ct_acute_tot","strain_ct_chronic_tot")
